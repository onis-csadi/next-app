        ...
        <div className="min-h-full">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <Link href="/users"><a className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Users</a></Link>

                                    <Link href="/api/users"><a className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Api</a></Link>
            ...
            <footer className='p-4 border-t-2'>
                <div className='container flex justify-center text-xs'>
                    <span>Developed by Onis Csadi</span>
                </div>
            </footer>
        </div>
